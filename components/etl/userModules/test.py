...
SparkContext.setSystemProperty("hive.metastore.uris", "thrift://localhost:9803")
...
df = mySpark.read.csv("/home/setupadmin/adbiz/components/etl/input/actrbl/invoices/invoices.txt",sep="\t", header = True, mode = "DROPMALFORMED")
