...
try:
    ...
    if os.path.isfile(inputParameterFile):
        ...
        oEtlSettings = ClsEtlSettings(oETLParameters)
                                                ...
                                                if lstDataTarget is not None:
                                                    ...
                                                    if lstContainers is not None:
                                                        ...
                                                        for container  in curContainers:                                                            
                                                            dictContainers[container["containerCode"]] = container                                                        
                                                        ...
                                                        if lstAggregates is not None:
                                                            ...
                                                            for aggregate in curAggregates:                                                            
                                                                dictAggregates[aggregate["aggCode"]] = aggregate
                                                            ...
                                                            if curCalendars is not None:
                                                                for calendar in curCalendars:
                                                                    ...
                                                                    objModule = ClsCommonModule(mySpark, sModuleCode, oETLParameters, oEtlSettings._TX_DB_CONN, datamodel, sObjectName, dataset, dictContainers, dictAggregates, dictKPIs, calendar["dates"])
                                                                    objModule.executeETL()
                                                                    objModule.processKPIs("NEW")
