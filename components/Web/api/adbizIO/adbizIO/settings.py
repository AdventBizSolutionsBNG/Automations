...
LOG_CONFIG_FILE = os.path.join(BASE_DIR,"adbizIO","config","logging.json")
...
SECRET_KEY = 'i^8ti9#1ld#((aoo&v1wppah$-d7u0q(kopcu#i0s^7vyab)4*'
API_KEY = "1589cac7-150c-4f69-9bdd-e047454c3402"
