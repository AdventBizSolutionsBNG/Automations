...
urlpatterns = [
    ...
    path('actrbl_main/<dashboard_code>/', views.get_actrbl_main, name='actrbl_main'),
    path('actrbl_custom/<dashboard_code>/<period_start_date>/<period_end_date>/', views.get_actrbl_custom, name='actrbl_custom'),

    # path('actrbl_sales_summary/<dashboard_code>/', views.get_actrbl_sales_summary, name='actrbl_sales_summary'),
    # path('actrbl_sales_summary/<dashboard_code>/<period_start_date>/<period_end_date>/', views.get_actrbl_sales_summary_custom, name='actrbl_sales_summary_custom'),
    ...
    # path('actrbl_ageing_report/<dashboard_code>/<period_start_date>/<period_end_date>/', views.get_actrbl_ageing_report_custom, name='actrbl_ageing_report_custom'),
    #
