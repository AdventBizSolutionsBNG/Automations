# Generated by Django 3.0.5 on 2020-05-21 19:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_engine_code', models.CharField(editable=False, max_length=255, unique=True, verbose_name='Product Engine Code (generated)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_key', models.CharField(max_length=255, unique=True, verbose_name='License Key (generated)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key', models.CharField(max_length=255, unique=True, verbose_name='Activation Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site', models.CharField(max_length=255, verbose_name='Site')),
                ('instance_type', models.CharField(choices=[('DEV', 'Development'), ('QA', 'QA or SIT'), ('UAT', 'UAT'), ('PROD', 'Production')], max_length=48, verbose_name='Environment/Instance Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_engine_code', models.CharField(max_length=255, unique=True, verbose_name='Processing Engine')),
                ('activation_key', models.CharField(max_length=255, unique=True, verbose_name='Activation Key')),
                ('activation_dt', models.DateTimeField(editable=False, verbose_name='Activation Date Time')),
                ('deactivation_dt', models.DateTimeField(editable=False, null=True, verbose_name='Deactivation Date Time')),
                ('validity_start_date', models.DateTimeField(verbose_name='Validity Start Date')),
