# Generated by Django 3.0.5 on 2020-05-15 18:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('core_engine_code', models.UUIDField(default=uuid.uuid4, unique=True, verbose_name='Core Engine Code (generated)')),
                ('product_engine_code', models.CharField(max_length=64, verbose_name='Product Engine Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_engine_code', models.CharField(editable=False, max_length=64, verbose_name='Product Engine Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('environment_code', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='Environment ID (generated)')),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Customers', verbose_name='Customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site_code', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='Site ID (generated)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('processing_engine_type', models.CharField(choices=[('PE', 'ProductEngine'), ('CE', 'CoreEngine'), ('EE', 'ETLEngine'), ('KE', 'KPIEngine'), ('QE', 'QueryEngine'), ('UI', 'WEB UI ENGINE')], max_length=32, null=True, verbose_name='Processing Engine')),
                ('processing_engine_code', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='Processing Engine Code (generated)')),
                ('activation_key', models.CharField(editable=False, max_length=255, verbose_name=' Activation Key (generated)')),
                ...
                ('core_engine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.CoreEngine', verbose_name='Core Engine')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Customers', verbose_name='Customer')),
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Environments', verbose_name='Environment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('module', models.CharField(choices=[('ACTPBL', 'ACCOUNT PAYABLES'), ('ACTRBL', 'ACCOUNT RECEIVABLES'), ('RECO', 'RECONCILIATIONS')], max_length=255, verbose_name='Modules')),
                ('activation_key', models.CharField(editable=False, max_length=255, verbose_name=' Activation Key (generated)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_on', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='Last Updated On')),
                ('last_updated_by', models.CharField(editable=False, max_length=64, verbose_name='Last Updated By')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Customers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_by', models.CharField(editable=False, max_length=64, verbose_name='Last Updated By')),
                ('core_engine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.CoreEngine', verbose_name='Core Engine')),
                ('customer', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Customers', verbose_name='Customer')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='adbizCoreEngine.Customers', verbose_name='Customer'),
        ),
    ]
