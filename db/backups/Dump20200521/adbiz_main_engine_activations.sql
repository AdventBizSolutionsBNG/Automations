...
CREATE TABLE `engine_activations` (
  ...
  PRIMARY KEY (`id`),
  KEY `engine_activations_engine_id_30855c11_fk_engine_me` (`engine_id`),
  CONSTRAINT `engine_activations_engine_id_30855c11_fk_engine_me` FOREIGN KEY (`engine_id`) REFERENCES `engine_metadata` (`engine_id`)
