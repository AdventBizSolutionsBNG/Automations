...
CREATE TABLE `kpis` (
  ...
  `kpi_location` varchar(255) NOT NULL,
  `kpi_class` varchar(255) DEFAULT NULL,
  `kpi_name` varchar(255) NOT NULL,
  `kpi_description` longtext,
  ...
  PRIMARY KEY (`id`),
  KEY `kpis_catalog_id_e34b4c7d_fk_catalogs_id` (`catalog_id`),
  KEY `kpis_datamodel_id_6788b2f7_fk_datamodels_id` (`datamodel_id`),
  CONSTRAINT `kpis_catalog_id_e34b4c7d_fk_catalogs_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalogs` (`id`),
  CONSTRAINT `kpis_datamodel_id_6788b2f7_fk_datamodels_id` FOREIGN KEY (`datamodel_id`) REFERENCES `datamodels` (`id`)
