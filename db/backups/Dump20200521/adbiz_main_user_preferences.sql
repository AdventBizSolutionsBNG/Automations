...
CREATE TABLE `user_preferences` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_preferences_preference_id_399d6869_fk_preferences_id` (`preference_id`),
  KEY `user_preferences_user_id_7d5d22f7_fk_users_id` (`user_id`),
  CONSTRAINT `user_preferences_preference_id_399d6869_fk_preferences_id` FOREIGN KEY (`preference_id`) REFERENCES `preferences` (`id`),
